...
if (isset($_POST['update'])) {
    ...
    if ($sql->execute() === TRUE) {
        echo "<script>alert('Data UserID $userID Had Been Updated!'); window.location.href='staff-custList.php';</script>";
    } else {
        echo "<script>alert('Error updating record'); window.location.href='staff-custList.php';</script>";
    }
