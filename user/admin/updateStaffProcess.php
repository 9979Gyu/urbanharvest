...
if ($sql->execute() === TRUE) {
    echo "<script>alert('Data Staff $userID has been updated!'); window.location.href='admin-add-staff.php';</script>";
} else {
    echo "<script>alert('Error updating record'); window.location.href='admin-add-staff.php';</script>";
}
