                            ...
                            <tr>
                                ...
                                <td>
                                    <?php 
                                        if($getStatus == 0) {
                                            echo '
                                            <input type="radio" name="status" id="status" value="0" checked required/> Damaged
                                            <input type="radio" name="status" id="status" value="1" />Fixed ';
                                        } else{
                                            echo '
                                            <input type="radio" name="status" id="status" value="0" required/> Damaged
                                            <input type="radio" name="status" id="status" value="1" checked/>Fixed';
                                        }
                                    ?>
